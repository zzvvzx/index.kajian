...
const ROOT     = "/storage/sdcard0/Download/script/pengumpul.ilmu/data/";
...
<li>
  ...
  <span>${time(parseFloat(META.total_duration)*3600)} / ${META.total_size}Mb - ${META.total_items} items</span>
</li>`;
};
